...
public class PatientCarnetHealthHistory implements Serializable{
	...
	PatientCarnetHealthHistory(){}
    
	public PatientCarnetHealthHistory(int patient_health_history_id, int patient_id, int institution_id,
			int provider_id, String diagnostics, Date diagnotic_date, String diagnostic_service, float diagnostic_fees,
